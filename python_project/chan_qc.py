...
hosts_temp = "hosts"
redirect = "127.0.0.1"
web_sites_list = ["www.pornhub.com", "pornhub.com"]# users can modify the list of the websites they want to block
# cách sửa là vào C:\Windows\System32\drivers\etc\hosts và xóa mới
